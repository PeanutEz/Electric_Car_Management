 ...
 */
export async function getSellerProfile(sellerId: number, page: number = 1, limit: number = 6) {
	...
	// 4. Lấy danh sách posts đang active của seller (pagination bằng page & limit)
