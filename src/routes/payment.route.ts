 ...
 *   post:
 *     summary: Cancel payment and update order status to CANCELLED
 *     description: Manual cancellation endpoint since PayOS doesn't support cancel webhook
 *     tags: [Payment]
 *     parameters:
 *       - in: path
 *         name: orderCode
 ...
 *                 message:
 *                   type: string
 *                   example: "Cannot cancel paid order"
 *       404:
 ...
 *                 message:
 *                   type: string
 *                   example: "Order with code 123456 not found"
 *       500:
 *         description: Internal server error
 */
router.post('/cancel/:orderCode', cancelPaymentController);
